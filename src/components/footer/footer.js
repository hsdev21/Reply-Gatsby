...
const Footer = () => (
  <footer>
    <Container className={footerStyles.footerTextContainer***REMOVED***>
      <Row>
        <Col className={`${footerStyles.footerLogo***REMOVED*** text-center`***REMOVED***>
          <img
    ...
    <Container className={footerStyles.footerCopyRight***REMOVED*** fluid>
      <span>
        &copy; {new Date().getFullYear()***REMOVED*** Valley Radiology. All rights reserved.
        | Website by{" "***REMOVED***
        <a href="https://patientfetch.com" target="_blank" rel={"noreferrer"***REMOVED***>
          PatientFetch
        </a>
      </span>
    </Container>
